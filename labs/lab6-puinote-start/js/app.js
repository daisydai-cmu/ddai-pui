...
function submitNote() {
  ...
  //call this function whenever note is created
  saveToLocalStorage();
}

//what you need for hw6
function saveToLocalStorage() {
  ...
  //get it backout to array, separate them into 2 variables to be clean
  var firstvar = localStorage.getItem('storedNotes')
  let temps = JSON.parse(firstvar);
  console.log(temps);
}